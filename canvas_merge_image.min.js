...
b.FontBgSize&&(d+=b.FontBgSize);e=init_canvas(c,d);e.fillStyle=b.text_color;e.font=b.text_size+"px \u5fae\u8edf\u6b63\u9ed1\u9ad4";e.textBaseline="middle";var f=b.text_size/2;b.useFontBg&&b.FontBgSize&&(f+=b.FontBgSize/2,e.lineWidth=b.FontBgSize,e.strokeStyle=b.FontBgColor,e.strokeText(a,0,f));e.fillText(a,0,f);b.useLine&&(a=1==b.useLine?.9:.5,e.strokeStyle=b.text_color,e.lineWidth=Math.floor(b.text_size/10),f=d*a-e.lineWidth/2,e.moveTo(0,f),e.lineTo(c,f),e.stroke());return e.canvas}a.text_size>a.h&&
(a.text_size=a.h);(function(a){var b=a.text_content.length*a.text_size*a.text_size,c=Math.sqrt(b/(a.w/a.h)),b=b/c;c>b&&(b=c);a.text_size=Math.floor(a.w/b*a.text_size)})(a);var g=init_canvas(a.w,a.h);g.fillStyle=a.text_color;g.font=a.text_size+"px \u5fae\u8edf\u6b63\u9ed1\u9ad4";g.textBaseline="middle";a.useFontBg&&a.FontBgSize&&(g.lineWidth=a.FontBgSize,g.strokeStyle=a.FontBgColor,g.strokeText(h,d,n));2==a.text_type&&(a.text_content=a.text_content.split("").join("\n"));for(var u=0;;){u++;n=a.text_content.trim();
d=!1;if(1==a.text_type)var r=[n],h=g.measureText(n).width;else r=q(a,g),h=r.map(function(a){return g.measureText(a).width}).reduce(function(a,b){return a>b?a:b},0);d=d||h>a.w;h=r.length*(a.useFontBg&&a.FontBgSize?1.2*a.text_size+a.FontBgSize:1.2*a.text_size);if(d=d||h>a.h)g.font=--a.text_size+"px \u5fae\u8edf\u6b63\u9ed1\u9ad4",a.text_content=n;else break}var n=0;1==a.text_vAlign?n=(a.h-h)/2:2==a.text_vAlign&&(n=a.h-h);for(var v in r){var h=r[v].replace(/###space###/g," "),h=t(h,a,g),d=0;1==a.text_hAlign?
d=(a.w-h.width)/2:2==a.text_hAlign&&(d=a.w-h.width);g.drawImage(h,d,n);n+=h.height}k.push("\u5716\u5c64"+f+"\u6587\u5b57\u5408\u6210\u5224\u65b7"+u+"\u6b21");return g.canvas};
