...
d=!1;if(1==a.text_type)var r=[n],h=g.measureText(n).width;else r=q(a,g),h=r.map(function(a){return g.measureText(a).width}).reduce(function(a,b){return a>b?a:b},0);d=d||h>a.w;h=r.length*(a.useFontBg&&a.FontBgSize?1.2*a.text_size+a.FontBgSize:1.2*a.text_size);if(d=d||h>a.h)g.font=--a.text_size+"px \u5fae\u8edf\u6b63\u9ed1\u9ad4",a.text_content=n;else break}var n=0;1==a.text_vAlign?n=(a.h-h)/2:2==a.text_vAlign&&(n=a.h-h);for(var v in r){var h=r[v],h=t(h,a,g),d=0;1==a.text_hAlign?d=(a.w-h.width)/2:2==
a.text_hAlign&&(d=a.w-h.width);g.drawImage(h,d,n);n+=h.height}k.push("\u5716\u5c64"+f+"\u6587\u5b57\u5408\u6210\u5224\u65b7"+u+"\u6b21");return g.canvas};
